...
async def main():
    ...
    while running:
        ...
        for e in events:
            ...
            # --- 1. OYUN İÇİ KONTROLLER ---
            if state == "GAME":
                # ESC Butonu (Dokunmatik veya Mouse)
                if mx != -1 and BTN_ESC.collidepoint(mx, my):
                    pygame.mixer.music.stop()
                    state = "MENU"
                
                # Joystick Hareketleri
            ...
            # --- 2. MENÜ KONTROLLERİ ---
                ...
                # Klavye Girişleri (JSON Yazma Modu)
